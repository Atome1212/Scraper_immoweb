...
class ImmowebScraper:
    ...
    def save_data(self, data: Dict[str, Any], filename: str) -> None:
        ...
        property_info = {
            ...
            "Price": data["transaction"]["sale"]["price"] if self.type_of_sale == "sale" else data["transaction"]["rent"]["monthlyRentalPrice"],
            ...
            "Furnished": data["transaction"]["sale"]["isFurnished"] if self.type_of_sale == "sale" else data["transaction"]["rent"]["isFurnished"],
